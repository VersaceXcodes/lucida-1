	...
	en: {
		translation: {
			...
			home: {
				coreFeatures: {
					key: "WHY LUCIDA",
					title: "Your Home Services Booking App",
					content:
				...
				downloadApp: {
					...
					content:
						"Your home services app. Book cleaning, maintenance, and more in just a few taps.",
				},
				faq: {
					name: "GOT QUESTIONS?",
					title: "FAQ",
		...
		translation: {
			...
			home: {
				...
				downloadApp: {
					...
					content:
						"تطبيق خدمات منزلية. احجز التنظيف والصيانة وأكثر بضغطات قليلة.",
				},
				faq: {
					name: "هل لديك أسئلة؟",
